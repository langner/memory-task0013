...
ArchivePlugin.SetFrequency(1)
MBFHybridCalculator.AddPlugin(ArchivePlugin)
MBFHybridCalculator_Parameters = MBFHybridCalculator.GetParametersCmds()
MBFHybridCalculator_Parameters.SetBeadFieldCoupling("P", "A", 0)
MBFHybridCalculator_Parameters.SetBeadFieldCoupling("P", "B", 0)
MBFHybridCalculator_Parameters.SetBeadFieldCoupling("C", "A", 0)
MBFHybridCalculator_Parameters.SetBeadFieldCoupling("C", "B", 0)
MBFHybridCalculator.Run(100)
